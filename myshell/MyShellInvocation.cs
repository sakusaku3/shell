...
namespace myshell
{
	public class MyShellInvocation : shell.ViewModel.IShellInvocation
	{
		#region フィールド
		/// <summary>
		/// 呼び出しを受け付けて発火するメソッド
		/// </summary>
		private readonly Action<MyShellInvocation> invocationAction;
		...
		#region コンストラクタ
		internal MyShellInvocation(
			int p_number, 
			Action<MyShellInvocation> p_invocationAction, 
